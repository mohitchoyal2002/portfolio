  ...
  return (
    ...
    <div id='contact-me' className='p-10 font-nunito bg-sky-300'>
      ...
      <div className='flex justify-evenly flex-wrap gap-5'>
        <a href='mailto: mohitchoyal2002@gmail.com' className=''><div className='py-6 px-36 flex flex-col items-center gap-2 bg-sky-100 transition delay-75 hover:shadow-whitner rounded-md'>
    ...
    <h1 className='my-2 w-full justify-center flex items-center gap-2 text-center text-xs text-blue-950'>MohitWebDev <span><AiOutlineCopyrightCircle className='text-blue-950' fontSize={12}/></span> 2024</h1>
    </>
  )
}
